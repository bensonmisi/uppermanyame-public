    ...
    <v-container fluid>
      ...
      <div class="mt-3">
        ...
        <v-card-title>
            ...
            <v-spacer/>
            <v-col md="4">
               <v-select outlined dense label="My Property" v-model="property" :items="properties" item-value="id" item-text="address" @change="retrievestatement"/>
...
export default {
  ...
  methods:{
     async retrievestatement(){
         await this.$store.dispatch('statement/getData',this.property)
     }
  },
  computed: {
    properties(){
