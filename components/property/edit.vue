...
export default {
 ...
 data(){
  ...
  if (typeof google === 'undefined') {
     ...
     this.form.streetnumber = this.property.streetnumber
     this.form.streetname = this.property.streetname
     this.form.area = this.property.area
     this.form.owner = this.property.owner
     this.form.type = this.property.type
     this.form.size = this.property.size
     ...
     async add(){
       if(this.$refs.form.validate())
       {
        ...
        try {
            await this.$axios({
                method:"PATCH",
                url:'client-property/'+this.property.id,
                data:formData,
                config:config
            }).then(async (res)=>{
